...
const scotlandSearch = document.getElementById("search-scotland");
const walesSearch = document.getElementById("search-wales");
const northernIrelandSearch = document.getElementById("search-northern-ireland");

scotlandSearch.addEventListener("click", () => searchJobsInLocation('scotland'));
walesSearch.addEventListener("click", () => searchJobsInLocation('wales'));
northernIrelandSearch.addEventListener("click", () => searchJobsInLocation('northern-ireland'));
